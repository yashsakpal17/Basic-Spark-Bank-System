...
<body style="background-image:url('statics/contactus_back.jpg'); padding-top:8%;">
    ...
    <center>
        ...
        <div class="container" style="margin-top:2%;">
            <div
                style="width:80%; background-color:rgba(7,84,132); padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px dark-gray;">
