...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="statics/logo3.jpg">
    <link rel="icon" type="image/jpg" sizes="32x32" href="statics/logo3.jpg">
    <link rel="icon" type="image/jpg" sizes="16x16" href="statics/logo3.jpg">
...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="statics\logo3.jpg" alt=""
    ...
    <div class="container-large"
        style="color:white; height:500px; width: 100%; padding:8% 2% 2% 2%; background-image:url('statics/home_back1.jpg');">
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b>Welcome to <br> Bank of Sparks </b></p>
            </div>
           <div class="col" style="margin:4% 0% 0% 111%; text-align:center;">
                &nbsp;<img src="statics/home_img.png" width="300" height="300" class="zoomin" alt="" style="width:0px;">
            </div>
        </div>
    </div>
    <img src="statics/home_back2.jpg" alt="" style="width:100%; position:absolute; z-index:-1">
