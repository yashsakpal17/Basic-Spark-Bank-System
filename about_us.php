...
<body style="background-image:url('statics/contactus_back.jpg')">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            <div
                style="width:80%; background-color:rgba(7,84,132); padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
                <h1 style=" color:white;">About Us</h1>
            </div>
            <br><br>
            <img src="statics\yash.jpg" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:black;">This website is created by</p>
            <h1 style="color:black; text-shadow:2px 2px 2px gray;">Yash Sakpal</h1>
            <p style="color:#545454;"><b>Intern at Sparks Foundation <br> Thakur College of Engineering and Technology, Mumbai</b></p>
    </center>
